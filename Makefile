...
CFLAGS:=-std=c++11 -g -Wall -Wno-sign-compare -O0 -DGL_GLEXT_PROTOTYPES #-DFAKEMAP
CXXFLAGS:=$(CFLAGS)
LDFLAGS:= -lGL -lGLU -lglut -lz -g

noeuclid : noeuclid.o OGLParts.o GameMap.o Common.o RTHelper.o Map.o scripthelpers.o Room.o
	$(CXX) -o $@ $^ $(LDFLAGS)
